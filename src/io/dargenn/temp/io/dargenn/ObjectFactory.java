 ...
 * generated in the io.dargenn package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldResponse_QNAME = new QName("http://dargenn.io/", "getHelloWorldResponse");
    private final static QName _GetHelloWorld_QNAME = new QName("http://dargenn.io/", "getHelloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: io.dargenn
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dargenn.io/", name = "getHelloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dargenn.io/", name = "getHelloWorld")
