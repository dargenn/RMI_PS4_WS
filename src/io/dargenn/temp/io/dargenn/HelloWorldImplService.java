 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://dargenn.io/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://dargenn.io/", "HelloWorldImplService");
    ...
    public io.dargenn.HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://dargenn.io/", "HelloWorldImplPort"), io.dargenn.HelloWorld.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloWorldImplPort")
    public io.dargenn.HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dargenn.io/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
